...
class _DesktopShellScreenState extends State<DesktopShellScreen> {
  ...
  Future<void> _pickAndImport() async {
    ...
    try {
      ...
      final fileMessage = 'DESKTOP_IMPORT_FILE name=${pickedFile.name} path=${pickedFile.path}';
  ...
  void _refreshLibrary() {
    ...
    _uiTrace('DESKTOP_REFRESH_LIBRARY_APPLIED libraryReloadTick=$_libraryReloadTick');
  }
