          ...
          child: ListView(
            ...
            children: [
              if (currentBookTitle != null &&
                  currentBookTitle!.trim().isNotEmpty) ...[
                Text(
                  currentBookTitle!,
                ...
                const Text('Current desktop reader book'),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 12),
                      Text(
                        'Desktop navigation now follows the mobile shell: Library, Reader, and Settings are available through the bottom tabs.',
                      ),
                    ],
                  ),
                ),
