...
class ParagraphSegmentV2Item {
  ...
  factory ParagraphSegmentV2Item.fromJson(Map<String, dynamic> json) {
    return ParagraphSegmentV2Item(
      ...
      translationKind:
          json['translation_kind'] as String? ?? 'provider_fallback',
      analysisVersion: json['analysis_version'] as String? ?? 'legacy_v1',
      segmentMeta: (json['segment_meta'] as Map<String, dynamic>? ??
          const <String, dynamic>{}),
      sourceAnalysis: (json['source_analysis'] as Map<String, dynamic>? ??
          const <String, dynamic>{}),
      sourceLookup: (json['source_lookup'] as Map<String, dynamic>? ??
          const <String, dynamic>{}),
      sourceCoverage: (json['source_coverage'] as Map<String, dynamic>? ??
          const <String, dynamic>{}),
      sourceEffective: (json['source_effective'] as Map<String, dynamic>? ??
          const <String, dynamic>{}),
      segmentAlignment: (json['segment_alignment'] as Map<String, dynamic>? ??
          const <String, dynamic>{}),
    );
  }
}
...
class ParagraphWordItem {
  ...
  factory ParagraphWordItem.fromJson(Map<String, dynamic> json) {
    ...
    final unitTranslationSpanText =
        json['unit_translation_span_text'] as String? ?? '';
    final unitTranslationLeftText =
        json['unit_translation_left_text'] as String? ?? '';
    final unitTranslationFocusText =
        json['unit_translation_focus_text'] as String? ?? '';
    final unitTranslationRightText =
        json['unit_translation_right_text'] as String? ?? '';
    ...
    final translationFocusText =
        json['translation_focus_text'] as String? ?? '';
    final translationRightText =
        json['translation_right_text'] as String? ?? '';
    return ParagraphWordItem(
      ...
      sourceFirstCoverageStatus:
          json['source_first_coverage_status'] as String?,
      sourceFirstEffectiveSource:
          json['source_first_effective_source'] as String?,
      effectiveTranslationText:
          (json['effective_translation_text'] as String?)?.isNotEmpty == true
              ...
              : (sourceFirstFocusText?.isNotEmpty == true
                  ...
                  : (unitTranslationFocusText.isNotEmpty
                      ...
                      : (unitTranslationSpanText.isNotEmpty
                          ...
                          : (translationFocusText.isNotEmpty
                              ? translationFocusText
                              : translationSpanText)))),
      effectiveLeftText:
          (json['effective_left_text'] as String?)?.isNotEmpty == true
              ? json['effective_left_text'] as String?
              : (sourceFirstLeftText?.isNotEmpty == true
                  ? sourceFirstLeftText
                  : (unitTranslationLeftText.isNotEmpty
                      ? unitTranslationLeftText
                      : translationLeftText)),
      effectiveFocusText:
          (json['effective_focus_text'] as String?)?.isNotEmpty == true
              ...
              : (sourceFirstFocusText?.isNotEmpty == true
                  ...
                  : (unitTranslationFocusText.isNotEmpty
                      ...
                      : (translationFocusText.isNotEmpty
                          ...
                          : translationSpanText))),
      effectiveRightText:
          (json['effective_right_text'] as String?)?.isNotEmpty == true
              ? json['effective_right_text'] as String?
              : (sourceFirstRightText?.isNotEmpty == true
                  ? sourceFirstRightText
                  : (unitTranslationRightText.isNotEmpty
                      ? unitTranslationRightText
                      : translationRightText)),
      effectiveMatchedBy:
          (json['effective_matched_by'] as String?)?.isNotEmpty == true
              ...
              : ((json['source_first_unit_id'] as String?)?.isNotEmpty == true
                  ...
                  : (unitTranslationFocusText.isNotEmpty
                      ...
                      : (translationFocusText.isNotEmpty
                          ? 'legacy_alignment'
                          : null))),
      effectiveAlignmentKind:
          (json['effective_alignment_kind'] as String?)?.isNotEmpty == true
...
class TtsJobItem {
  ...
  factory TtsJobItem.fromJson(Map<String, dynamic> json) {
    return TtsJobItem(
      ...
      playbackProgress: (json['playback_progress'] as num?)?.toDouble() ?? 0.0,
      errorMessage: json['error_message'] as String?,
    );
  }
}
...
class TtsState {
  ...
  factory TtsState.fromJson(Map<String, dynamic> json) {
    ...
    final activeSegments =
        (json['active_segments'] as List<dynamic>? ?? const [])
            .cast<Map<String, dynamic>>()
