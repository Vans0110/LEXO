...
def main() -> None:
    parser = argparse.ArgumentParser(description="Materialize a reviewed UK layer and seeds")
    ...
    write(directory / "seed_words_uk.json", seed_words)
    write(directory / "seed_blocks_uk.json", seed_blocks)
    write(directory / "word_to_word_uk.json", verification)
