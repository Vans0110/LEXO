...
class _MobileLibraryScreenState extends State<MobileLibraryScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                  'This will delete the local mobile copy and downloaded audio files.'),
  ...
  Future<void> _updateBook(LibraryBookItem item) async {
    ...
    try {
      ...
      final package =
          await widget.api.downloadMobileBookPackageChunked(desktopBookId);
      final meta =
      ...
      final readerPayload =
          package['reader_payload'] as Map<String, dynamic>? ??
              <String, dynamic>{};
      readerPayload['current_paragraph_index'] =
          localPackage.meta.currentParagraphIndex;
  ...
  Future<void> _openSettings() async {
    final settingsRepository = MobileSettingsRepository();
          ...
          children: [
            ...
            Expanded(
              child: library == null || library.items.isEmpty
                  ? const Center(
                      child: Text('The local mobile library is empty'))
                  : ListView.separated(
