...
def alignment_group_fixture() -> tuple[dict, dict]:
    layer = {
        ...
        "words": [
            ...
            {"word": "room", "lemma": "room", "pos": "NOUN", "translation": "класі", "translations": ["класі"]},
        ],
        "blocks": [],
    }
    proof = {
        ...
        "entries": [
            ...
            {"word_id": "w3", "segment_index": 0, "source_order": 3, "surface": "room", "lemma": "room", "pos": "NOUN", "contextual_translation": "класі", "dictionary_translation": "", "status": "independent_translation", "owner_unit_id": "word:w3", "tap_unit_id": "word:w3", "target_start_index": 3, "target_end_index": 3, "empty_reason": ""},
        ],
        "alignment_groups": [
            {
...
def number_group_fixture() -> tuple[dict, dict]:
    layer = {
        "book_id": "book_number",
        "parallel": [{"source": "Room fourteen", "translation": "кімнаті номер чотирнадцять"}],
        "words": [
            {"word": "Room", "lemma": "room", "pos": "PROPN", "translation": "кімнаті", "translations": ["кімнаті"]},
            {"word": "fourteen", "lemma": "fourteen", "pos": "NUM", "translation": "чотирнадцять", "translations": ["чотирнадцять"]},
        ],
        "blocks": [],
    }
    proof = {
        ...
        "target_lang": "uk",
        "entries": [
            {"word_id": "n0", "segment_index": 0, "source_order": 0, "surface": "Room", "lemma": "room", "pos": "PROPN", "contextual_translation": "кімнаті", "dictionary_translation": "", "status": "independent_translation", "owner_unit_id": "word:n0", "tap_unit_id": "word:n0", "target_start_index": 0, "target_end_index": 0, "empty_reason": ""},
            {"word_id": "n1", "segment_index": 0, "source_order": 1, "surface": "fourteen", "lemma": "fourteen", "pos": "NUM", "contextual_translation": "чотирнадцять", "dictionary_translation": "", "status": "independent_translation", "owner_unit_id": "word:n1", "tap_unit_id": "word:n1", "target_start_index": 2, "target_end_index": 2, "empty_reason": ""},
        ],
        "alignment_groups": [
            {"unit_id": "alignment_group:0:0", "kind": "structural_recast", "segment_index": 0, "source_word_ids": ["n0", "n1"], "group_only_word_ids": [], "source_text": "Room fourteen", "target_start_index": 0, "target_end_index": 2, "target_text": "кімнаті номер чотирнадцять", "reason": "The target inserts a structural classifier."}
        ],
        "block_occurrences": [],
        "target_coverage": [],
    }
