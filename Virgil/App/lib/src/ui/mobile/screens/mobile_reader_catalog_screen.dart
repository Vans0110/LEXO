    ...
    final opened = await Navigator.of(navContext).push<bool>(
      MaterialPageRoute(
        builder: (_) => VirgilBookDetailScreen(
          ...
          localBook: item,
          bundledBook: remoteBook,
          busy: false,
          onToggleFavorite: () => _toggleFavorite(favoriteKey),
          onLoad: remoteBook == null
              ? null
              : (options) => _importBundledBook(remoteBook, options: options),
          onOpen: _openBook,
    ...
    final opened = await Navigator.of(navContext).push<bool>(
      MaterialPageRoute(
        builder: (_) => VirgilBookDetailScreen(
          ...
          updateAvailable: localBook != null && _updateAvailable(localBook),
          localBook: localBook,
          bundledBook: item,
          busy: false,
...
class _ChapterImagePlaceholder extends StatelessWidget {
  const _ChapterImagePlaceholder({
