...
class DesktopTxtPicker {
  static const MethodChannel _channel = MethodChannel('lexo/windows_file_picker');

  static Future<PickedTxtFile?> pickTxtFile() async {
    if (!Platform.isWindows) {
      throw UnsupportedError('Windows TXT picker is unavailable on this platform.');
    }
    ...
    if (path == null || name == null || path.trim().isEmpty || name.trim().isEmpty) {
