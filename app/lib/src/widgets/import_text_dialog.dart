        ...
        builder: (context, setState) {
          void submit() {
            ...
            if (rawSource.isEmpty) {
              setState(() => errorText = 'Введите текст книги.');
              return;
            }
            final resolvedTitle = rawTitle.isNotEmpty ? rawTitle : _deriveTitle(rawSource);
            if (resolvedTitle.isEmpty) {
              setState(() => errorText = 'Введите название книги.');
              return;
            }
